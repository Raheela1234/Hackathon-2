// T039: TaskList component with loading, error, empty states - Updated with Purple Theme
...
export function TaskList({
  ...
  if (error && tasks.length === 0) {
    return (
      <div className="bg-red-500/10 text-red-400 border border-red-500/20 p-6 rounded-xl text-center">
  ...
  return (
    <div className="space-y-4">
      ...
      {pagination.totalPages > 1 && (
        <div className="flex items-center justify-between border-t border-[#A78BFA]/30 pt-4">
          ...
          <div className="flex gap-2">
            <Button
              variant="secondary"
              size="sm"
              className="bg-transparent text-[#A78BFA] border border-[#A78BFA]/30 hover:bg-[#A78BFA]/10"
