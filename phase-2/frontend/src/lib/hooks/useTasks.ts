...
export function useTasks(): UseTasksReturn {
  ...
  const goToPage = useCallback((page: number) => { fetchTasks(page); }, [fetchTasks]);
  ...
  return { tasks, loading, error, pagination, toggleComplete, deleteTask, createTask, updateTask, goToPage };
}
