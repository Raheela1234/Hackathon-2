...
export function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-background-card text-gray-700 hover:bg-background-hover border border-gray-200 focus:ring-gray-300',
    danger: 'bg-danger-500 text-white hover:bg-danger-600 hover:shadow-lg focus:ring-danger-500',
    ghost: 'bg-transparent text-primary-600 hover:bg-background-card hover:text-primary-500 focus:ring-primary-500',
  };
