...
export function TaskCard({ task, onToggleComplete, onEdit, onDelete }: TaskCardProps) {
  return (
    <div
      className="bg-background-card border border-gray-200 rounded-2xl p-5
        hover:bg-background-hover hover:border-gray-300 hover:shadow-card
        motion-safe:transform motion-safe:hover:scale-[1.02] transition-all duration-200"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <Button variant="danger" size="sm" onClick={onDelete} style={{ color: '#111827' }}>
              🗑️ Delete
            </Button>
          </div>
        </div>
