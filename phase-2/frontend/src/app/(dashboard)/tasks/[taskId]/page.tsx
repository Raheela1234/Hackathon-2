...
export default function TaskDetailPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-background-card border border-gray-200 shadow-card rounded-2xl p-6">
        <TaskForm
          mode="edit"
          initialData={task}
      ...
      >
        ...
        <div className="mt-3 bg-background-hover p-4 rounded-xl border border-gray-200">
