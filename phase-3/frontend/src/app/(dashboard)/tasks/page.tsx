// T041: Tasks page with TaskList and create button - Updated with Purple Theme
...
export default function TasksPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B12] text-[#EDEEF3] p-6">
      {/* Header */}
      ...
      {/* Task list */}
      <div className="bg-[#0F1020] rounded-xl p-6 border border-[#A78BFA]/30">
        <TaskList
          tasks={tasks}
          loading={loading}
          error={error}
